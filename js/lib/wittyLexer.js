...
ANTLR.lang.extend(wittyLexer, ANTLR.runtime.Lexer, {
    ...
    mNUM: function()  {
        try {
            ...
            switch (alt8) {
                case 1 :
                    // antlr/witty.g:82:21: '.' ( DIGIT )+
                    this.match('.'); 
                    // antlr/witty.g:82:25: ( DIGIT )+
                    var cnt7=0;
                    loop7:
                    do {
                        var alt7=2;
    ...
    mCOMMENT: function()  {
        try {
            ...
            // antlr/witty.g:84:11: ( '//' ( . )* CR )
            // antlr/witty.g:84:13: '//' ( . )* CR
            this.match("//"); 
    ...
    mTERM: function()  {
        try {
            this.type = this.TERM;
            // antlr/witty.g:85:11: ( ( CR | ';' )+ )
            // antlr/witty.g:85:13: ( CR | ';' )+
            // antlr/witty.g:85:13: ( CR | ';' )+
            var cnt10=0;
            loop10:
            do {
    ...
    mESC_SEQ: function()  {
        try {
            // antlr/witty.g:88:23: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | UNICODE_ESC | OCTAL_ESC )
            var alt11=3;
            ...
            if ( (LA11_0=='\\') ) {
                ...
                default:
                    var nvae =
                        new ANTLR.runtime.NoViableAltException("88:10: fragment ESC_SEQ : ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | UNICODE_ESC | OCTAL_ESC );", 11, 1, this.input);
                ...
                var nvae =
                    new ANTLR.runtime.NoViableAltException("88:10: fragment ESC_SEQ : ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | UNICODE_ESC | OCTAL_ESC );", 11, 0, this.input);

                throw nvae;
            }
            switch (alt11) {
                case 1 :
                    // antlr/witty.g:88:27: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' )
                    this.match('\\'); 
                    ...
                    break;
                case 2 :
                    // antlr/witty.g:88:71: UNICODE_ESC
                    this.mUNICODE_ESC(); 


                    break;
                case 3 :
                    // antlr/witty.g:88:85: OCTAL_ESC
                    this.mOCTAL_ESC(); 
    ...
    mOCTAL_ESC: function()  {
        try {
            // antlr/witty.g:89:23: ( '\\\\' ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) )
            var alt12=3;
            ...
            if ( (LA12_0=='\\') ) {
                ...
                if ( ((LA12_1>='0' && LA12_1<='3')) ) {
                    ...
                    var nvae =
                        new ANTLR.runtime.NoViableAltException("89:10: fragment OCTAL_ESC : ( '\\\\' ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) );", 12, 1, this.input);
                ...
                var nvae =
                    new ANTLR.runtime.NoViableAltException("89:10: fragment OCTAL_ESC : ( '\\\\' ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) );", 12, 0, this.input);

                throw nvae;
            }
            switch (alt12) {
                case 1 :
                    // antlr/witty.g:89:25: '\\\\' ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' )
                    this.match('\\'); 
                    // antlr/witty.g:89:30: ( '0' .. '3' )
                    // antlr/witty.g:89:31: '0' .. '3'
                    this.matchRange('0','3'); 



                    // antlr/witty.g:89:41: ( '0' .. '7' )
                    // antlr/witty.g:89:42: '0' .. '7'
                    this.matchRange('0','7'); 



                    // antlr/witty.g:89:52: ( '0' .. '7' )
                    // antlr/witty.g:89:53: '0' .. '7'
                    this.matchRange('0','7'); 
                    ...
                    break;
                case 2 :
                    // antlr/witty.g:89:65: '\\\\' ( '0' .. '7' ) ( '0' .. '7' )
                    this.match('\\'); 
                    // antlr/witty.g:89:70: ( '0' .. '7' )
                    // antlr/witty.g:89:71: '0' .. '7'
                    this.matchRange('0','7'); 



                    // antlr/witty.g:89:81: ( '0' .. '7' )
                    // antlr/witty.g:89:82: '0' .. '7'
                    this.matchRange('0','7'); 
                    ...
                    break;
                case 3 :
                    // antlr/witty.g:89:94: '\\\\' ( '0' .. '7' )
                    this.match('\\'); 
                    // antlr/witty.g:89:99: ( '0' .. '7' )
                    // antlr/witty.g:89:100: '0' .. '7'
                    this.matchRange('0','7'); 
    ...
    mUNICODE_ESC: function()  {
        try {
            // antlr/witty.g:90:23: ( '\\\\' 'u' HEX_DIG HEX_DIG HEX_DIG HEX_DIG )
            // antlr/witty.g:90:27: '\\\\' 'u' HEX_DIG HEX_DIG HEX_DIG HEX_DIG
            this.match('\\'); 
            this.match('u'); 
            this.mHEX_DIG(); 
            this.mHEX_DIG(); 
    ...
    mHEX_DIG: function()  {
        try {
            // antlr/witty.g:91:23: ( ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' ) )
            // antlr/witty.g:91:25: ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' )
    ...
    mNON_OP: function()  {
        try {
            // antlr/witty.g:93:23: ( ( '_' | '~' | '#' | '$' | '?' | '`' | '.' ) )
            // antlr/witty.g:93:25: ( '_' | '~' | '#' | '$' | '?' | '`' | '.' )
    ...
    mDIGIT: function()  {
        try {
            // antlr/witty.g:95:19: ( '0' .. '9' )
            // antlr/witty.g:95:21: '0' .. '9'
            this.matchRange('0','9'); 
    ...
    mCR: function()  {
        try {
            // antlr/witty.g:97:19: ( ( '\\r' )? '\\n' )
            // antlr/witty.g:97:21: ( '\\r' )? '\\n'
            // antlr/witty.g:97:21: ( '\\r' )?
            var alt13=2;
