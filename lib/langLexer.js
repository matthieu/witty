// $ANTLR 3.0.1 antlr/lang.g 2008-06-25 20:52:39
...
ANTLR.lang.extend(langLexer, ANTLR.runtime.Lexer, {
    ...
    mSTRING: function()  {
        try {
            ...
            // antlr/lang.g:24:11: ( '\"' ( ESC_SEQ | ~ ( '\\\\' | '\"' ) )* '\"' )
            // antlr/lang.g:24:14: '\"' ( ESC_SEQ | ~ ( '\\\\' | '\"' ) )* '\"'
            this.match('\"'); 
            // antlr/lang.g:24:18: ( ESC_SEQ | ~ ( '\\\\' | '\"' ) )*
            loop1:
            do {
                var alt1=3;
    ...
    mID: function()  {
        try {
            this.type = this.ID;
            // antlr/lang.g:25:11: ( ( LETTER | SYMBOLS ) ( LETTER | DIGIT | SYMBOLS )* )
            // antlr/lang.g:25:13: ( LETTER | SYMBOLS ) ( LETTER | DIGIT | SYMBOLS )*
            ...
            // antlr/lang.g:25:32: ( LETTER | DIGIT | SYMBOLS )*
            loop2:
            do {
                var alt2=2;
    ...
    mINNT: function()  {
        try {
            this.type = this.INNT;
            // antlr/lang.g:26:11: ( ( DIGIT )+ )
            // antlr/lang.g:26:13: ( DIGIT )+
            // antlr/lang.g:26:13: ( DIGIT )+
            var cnt3=0;
            loop3:
            do {
    ...
    mSL_COMMENTS: function()  {
        try {
            ...
            // antlr/lang.g:28:7: ( ( '//' ) ( . )* CR )
            // antlr/lang.g:28:9: ( '//' ) ( . )* CR
            // antlr/lang.g:28:9: ( '//' )
            // antlr/lang.g:28:10: '//'
            this.match("//"); 
    ...
    mTERM: function()  {
        try {
            this.type = this.TERM;
            // antlr/lang.g:29:7: ( ( CR | ';' )+ )
            // antlr/lang.g:29:9: ( CR | ';' )+
            // antlr/lang.g:29:9: ( CR | ';' )+
            var cnt5=0;
            loop5:
            do {
    ...
    mESC_SEQ: function()  {
        try {
            // antlr/lang.g:32:23: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | UNICODE_ESC | OCTAL_ESC )
            var alt6=3;
            ...
            if ( (LA6_0=='\\') ) {
                ...
                default:
                    var nvae =
                        new ANTLR.runtime.NoViableAltException("32:10: fragment ESC_SEQ : ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | UNICODE_ESC | OCTAL_ESC );", 6, 1, this.input);
                ...
                var nvae =
                    new ANTLR.runtime.NoViableAltException("32:10: fragment ESC_SEQ : ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | UNICODE_ESC | OCTAL_ESC );", 6, 0, this.input);

                throw nvae;
            }
            switch (alt6) {
                case 1 :
                    // antlr/lang.g:32:27: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' )
                    this.match('\\'); 
                    ...
                    break;
                case 2 :
                    // antlr/lang.g:32:71: UNICODE_ESC
                    this.mUNICODE_ESC(); 


                    break;
                case 3 :
                    // antlr/lang.g:32:85: OCTAL_ESC
                    this.mOCTAL_ESC(); 
    ...
    mOCTAL_ESC: function()  {
        try {
            // antlr/lang.g:33:23: ( '\\\\' ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) )
            var alt7=3;
            ...
            if ( (LA7_0=='\\') ) {
                ...
                if ( ((LA7_1>='0' && LA7_1<='3')) ) {
                    ...
                    var nvae =
                        new ANTLR.runtime.NoViableAltException("33:10: fragment OCTAL_ESC : ( '\\\\' ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) );", 7, 1, this.input);
                ...
                var nvae =
                    new ANTLR.runtime.NoViableAltException("33:10: fragment OCTAL_ESC : ( '\\\\' ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) );", 7, 0, this.input);

                throw nvae;
            }
            switch (alt7) {
                case 1 :
                    // antlr/lang.g:33:25: '\\\\' ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' )
                    this.match('\\'); 
                    // antlr/lang.g:33:30: ( '0' .. '3' )
                    // antlr/lang.g:33:31: '0' .. '3'
                    this.matchRange('0','3'); 



                    // antlr/lang.g:33:41: ( '0' .. '7' )
                    // antlr/lang.g:33:42: '0' .. '7'
                    this.matchRange('0','7'); 



                    // antlr/lang.g:33:52: ( '0' .. '7' )
                    // antlr/lang.g:33:53: '0' .. '7'
                    this.matchRange('0','7'); 
                    ...
                    break;
                case 2 :
                    // antlr/lang.g:33:65: '\\\\' ( '0' .. '7' ) ( '0' .. '7' )
                    this.match('\\'); 
                    // antlr/lang.g:33:70: ( '0' .. '7' )
                    // antlr/lang.g:33:71: '0' .. '7'
                    this.matchRange('0','7'); 



                    // antlr/lang.g:33:81: ( '0' .. '7' )
                    // antlr/lang.g:33:82: '0' .. '7'
                    this.matchRange('0','7'); 
                    ...
                    break;
                case 3 :
                    // antlr/lang.g:33:94: '\\\\' ( '0' .. '7' )
                    this.match('\\'); 
                    // antlr/lang.g:33:99: ( '0' .. '7' )
                    // antlr/lang.g:33:100: '0' .. '7'
                    this.matchRange('0','7'); 
    ...
    mUNICODE_ESC: function()  {
        try {
            // antlr/lang.g:34:23: ( '\\\\' 'u' HEX_DIG HEX_DIG HEX_DIG HEX_DIG )
            // antlr/lang.g:34:27: '\\\\' 'u' HEX_DIG HEX_DIG HEX_DIG HEX_DIG
            this.match('\\'); 
            this.match('u'); 
            this.mHEX_DIG(); 
            this.mHEX_DIG(); 
    ...
    mSYMBOLS: function()  {
        try {
            // antlr/lang.g:36:23: ( ( '_' | '-' | '~' | '!' | '@' | '#' | '$' | '%' | '^' | '&' | '<' | '>' | '*' | '+' | '=' | '|' | '\\\\' | ':' | '.' | '?' | '/' ) )
            // antlr/lang.g:36:25: ( '_' | '-' | '~' | '!' | '@' | '#' | '$' | '%' | '^' | '&' | '<' | '>' | '*' | '+' | '=' | '|' | '\\\\' | ':' | '.' | '?' | '/' )
    ...
    mCR: function()  {
        try {
            // antlr/lang.g:38:14: ( ( '\\r' | '\\n' ) )
            // antlr/lang.g:38:16: ( '\\r' | '\\n' )
            if ( this.input.LA(1)=='\n'||this.input.LA(1)=='\r' ) {
                this.input.consume();
    ...
    mDIGIT: function()  {
        try {
            // antlr/lang.g:39:17: ( '0' .. '9' )
            // antlr/lang.g:39:22: '0' .. '9'
            this.matchRange('0','9'); 
    ...
    mHEX_DIG: function()  {
        try {
            // antlr/lang.g:41:18: ( ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' ) )
            // antlr/lang.g:41:20: ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' )
    ...
    mTokens: function() {
        // antlr/lang.g:1:8: ( T18 | T19 | T20 | STRING | ID | INNT | SL_COMMENTS | TERM | WS )
        var alt8=9;
...
ANTLR.lang.extend(langLexer.DFA8, ANTLR.runtime.DFA, {
    getDescription: function() {
        return "1:1: Tokens : ( T18 | T19 | T20 | STRING | ID | INNT | SL_COMMENTS | TERM | WS );";
    },
    dummy: null
});
