// $ANTLR 3.0.1 lang.g 2008-06-20 22:14:14
...
ANTLR.lang.extend(langLexer, ANTLR.runtime.Lexer, {
    ...
    mID: function()  {
        try {
            this.type = this.ID;
            // lang.g:19:11: ( ( LETTER | SYMBOLS ) ( LETTER | DIGIT | SYMBOLS )* )
            // lang.g:19:13: ( LETTER | SYMBOLS ) ( LETTER | DIGIT | SYMBOLS )*
            ...
            // lang.g:19:32: ( LETTER | DIGIT | SYMBOLS )*
            loop1:
            do {
                var alt1=2;
    ...
    mSTRING: function()  {
        try {
            ...
            // lang.g:21:11: ( '\"' ( ESCAPE_SEQ | ~ ( '\\\\' | '\"' ) )* '\"' )
            // lang.g:21:13: '\"' ( ESCAPE_SEQ | ~ ( '\\\\' | '\"' ) )* '\"'
            this.match('\"'); 
            // lang.g:21:17: ( ESCAPE_SEQ | ~ ( '\\\\' | '\"' ) )*
            loop3:
            do {
                var alt3=3;
    ...
    mESCAPE_SEQ: function()  {
        try {
            ...
            // lang.g:22:11: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) )
            // lang.g:22:13: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' )
            this.match('\\'); 
    ...
    mTokens: function() {
        // lang.g:1:8: ( T15 | T16 | T17 | ID | INNT | STRING | ESCAPE_SEQ | SL_COMMENTS | TERM )
        var alt6=9;
        ...
        switch (alt6) {
            ...
            case 6 :
                ...
                break;
            case 7 :
                // lang.g:1:37: ESCAPE_SEQ
                this.mESCAPE_SEQ(); 


                break;
            case 8 :
                // lang.g:1:48: SL_COMMENTS
                this.mSL_COMMENTS(); 
