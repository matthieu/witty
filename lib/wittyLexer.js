// $ANTLR 3.0.1 antlr/witty.g 2008-08-03 22:31:59
...
ANTLR.lang.extend(wittyLexer, ANTLR.runtime.Lexer, {
    ...
    mSYMBOLS: function()  {
        try {
            // antlr/witty.g:68:17: ( ( '_' | '~' | '@' | '#' | '$' | '%' | '^' | '&' | '<' | '>' | '*' | '+' | '=' | '|' | '\\\\' | '.' | '?' | '/' | '`' ) )
            // antlr/witty.g:68:19: ( '_' | '~' | '@' | '#' | '$' | '%' | '^' | '&' | '<' | '>' | '*' | '+' | '=' | '|' | '\\\\' | '.' | '?' | '/' | '`' )
    ...
    mID: function()  {
        try {
            this.type = this.ID;
            // antlr/witty.g:73:11: ( ( LETTER | NON_OP ) ( LETTER | DIGIT | NON_OP | '!' )* )
            // antlr/witty.g:73:13: ( LETTER | NON_OP ) ( LETTER | DIGIT | NON_OP | '!' )*
            ...
            // antlr/witty.g:73:31: ( LETTER | DIGIT | NON_OP | '!' )*
            loop4:
            do {
                var alt4=2;
    ...
    mSTRING: function()  {
        try {
            ...
            // antlr/witty.g:74:11: ( '\"' ( ESC_SEQ | ~ ( '\\\\' | '\"' ) )* '\"' )
            // antlr/witty.g:74:14: '\"' ( ESC_SEQ | ~ ( '\\\\' | '\"' ) )* '\"'
            this.match('\"'); 
            // antlr/witty.g:74:18: ( ESC_SEQ | ~ ( '\\\\' | '\"' ) )*
            loop5:
            do {
                var alt5=3;
    ...
    mNUM: function()  {
        try {
            this.type = this.NUM;
            // antlr/witty.g:75:11: ( ( DIGIT )+ ( '.' ( DIGIT )+ )? )
            // antlr/witty.g:75:13: ( DIGIT )+ ( '.' ( DIGIT )+ )?
            // antlr/witty.g:75:13: ( DIGIT )+
            var cnt6=0;
            loop6:
            do {
                var alt6=2;
            ...
            switch (alt8) {
                case 1 :
                    // antlr/witty.g:75:21: '.' ( DIGIT )+
                    this.match('.'); 
                    // antlr/witty.g:75:25: ( DIGIT )+
                    var cnt7=0;
                    loop7:
                    do {
                        var alt7=2;
    ...
    mCOMMENT: function()  {
        try {
            ...
            // antlr/witty.g:77:11: ( '//' ( . )* CR )
            // antlr/witty.g:77:13: '//' ( . )* CR
            this.match("//"); 
    ...
    mTERM: function()  {
        try {
            this.type = this.TERM;
            // antlr/witty.g:78:11: ( ( CR | ';' )+ )
            // antlr/witty.g:78:13: ( CR | ';' )+
            // antlr/witty.g:78:13: ( CR | ';' )+
            var cnt10=0;
            loop10:
            do {
    ...
    mESC_SEQ: function()  {
        try {
            // antlr/witty.g:81:23: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | UNICODE_ESC | OCTAL_ESC )
            var alt11=3;
            ...
            if ( (LA11_0=='\\') ) {
                ...
                default:
                    var nvae =
                        new ANTLR.runtime.NoViableAltException("81:10: fragment ESC_SEQ : ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | UNICODE_ESC | OCTAL_ESC );", 11, 1, this.input);
                ...
                var nvae =
                    new ANTLR.runtime.NoViableAltException("81:10: fragment ESC_SEQ : ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | UNICODE_ESC | OCTAL_ESC );", 11, 0, this.input);

                throw nvae;
            }
            switch (alt11) {
                case 1 :
                    // antlr/witty.g:81:27: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' )
                    this.match('\\'); 
                    ...
                    break;
                case 2 :
                    // antlr/witty.g:81:71: UNICODE_ESC
                    this.mUNICODE_ESC(); 


                    break;
                case 3 :
                    // antlr/witty.g:81:85: OCTAL_ESC
                    this.mOCTAL_ESC(); 
    ...
    mOCTAL_ESC: function()  {
        try {
            // antlr/witty.g:82:23: ( '\\\\' ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) )
            var alt12=3;
            ...
            if ( (LA12_0=='\\') ) {
                ...
                if ( ((LA12_1>='0' && LA12_1<='3')) ) {
                    ...
                    var nvae =
                        new ANTLR.runtime.NoViableAltException("82:10: fragment OCTAL_ESC : ( '\\\\' ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) );", 12, 1, this.input);
                ...
                var nvae =
                    new ANTLR.runtime.NoViableAltException("82:10: fragment OCTAL_ESC : ( '\\\\' ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) );", 12, 0, this.input);

                throw nvae;
            }
            switch (alt12) {
                case 1 :
                    // antlr/witty.g:82:25: '\\\\' ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' )
                    this.match('\\'); 
                    // antlr/witty.g:82:30: ( '0' .. '3' )
                    // antlr/witty.g:82:31: '0' .. '3'
                    this.matchRange('0','3'); 



                    // antlr/witty.g:82:41: ( '0' .. '7' )
                    // antlr/witty.g:82:42: '0' .. '7'
                    this.matchRange('0','7'); 



                    // antlr/witty.g:82:52: ( '0' .. '7' )
                    // antlr/witty.g:82:53: '0' .. '7'
                    this.matchRange('0','7'); 
                    ...
                    break;
                case 2 :
                    // antlr/witty.g:82:65: '\\\\' ( '0' .. '7' ) ( '0' .. '7' )
                    this.match('\\'); 
                    // antlr/witty.g:82:70: ( '0' .. '7' )
                    // antlr/witty.g:82:71: '0' .. '7'
                    this.matchRange('0','7'); 



                    // antlr/witty.g:82:81: ( '0' .. '7' )
                    // antlr/witty.g:82:82: '0' .. '7'
                    this.matchRange('0','7'); 
                    ...
                    break;
                case 3 :
                    // antlr/witty.g:82:94: '\\\\' ( '0' .. '7' )
                    this.match('\\'); 
                    // antlr/witty.g:82:99: ( '0' .. '7' )
                    // antlr/witty.g:82:100: '0' .. '7'
                    this.matchRange('0','7'); 
    ...
    mUNICODE_ESC: function()  {
        try {
            // antlr/witty.g:83:23: ( '\\\\' 'u' HEX_DIG HEX_DIG HEX_DIG HEX_DIG )
            // antlr/witty.g:83:27: '\\\\' 'u' HEX_DIG HEX_DIG HEX_DIG HEX_DIG
            this.match('\\'); 
            this.match('u'); 
            this.mHEX_DIG(); 
            this.mHEX_DIG(); 
    ...
    mHEX_DIG: function()  {
        try {
            // antlr/witty.g:84:23: ( ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' ) )
            // antlr/witty.g:84:25: ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' )
    ...
    mNON_OP: function()  {
        try {
            // antlr/witty.g:86:23: ( ( '_' | '~' | '#' | '$' | '?' | '`' | '.' ) )
            // antlr/witty.g:86:25: ( '_' | '~' | '#' | '$' | '?' | '`' | '.' )
    ...
    mDIGIT: function()  {
        try {
            // antlr/witty.g:88:19: ( '0' .. '9' )
            // antlr/witty.g:88:21: '0' .. '9'
            this.matchRange('0','9'); 
    ...
    mCR: function()  {
        try {
            // antlr/witty.g:90:19: ( ( '\\r' )? '\\n' )
            // antlr/witty.g:90:21: ( '\\r' )? '\\n'
            // antlr/witty.g:90:21: ( '\\r' )?
            var alt13=2;
