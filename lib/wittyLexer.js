// $ANTLR 3.0.1 antlr/witty.g 2008-07-06 09:22:36
...
ANTLR.lang.extend(wittyLexer, ANTLR.runtime.Lexer, {
    ...
    mESC_SEQ: function()  {
        try {
            ...
            if ( (LA7_0=='\\') ) {
                ...
                default:
                    var nvae =
                        new ANTLR.runtime.NoViableAltException("66:10: fragment ESC_SEQ : ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | UNICODE_ESC | OCTAL_ESC );", 7, 1, this.input);
                ...
                var nvae =
                    new ANTLR.runtime.NoViableAltException("66:10: fragment ESC_SEQ : ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | UNICODE_ESC | OCTAL_ESC );", 7, 0, this.input);
        ...
        try {
            ...
            if ( (LA8_0=='\\') ) {
                ...
                if ( ((LA8_1>='0' && LA8_1<='3')) ) {
                    ...
                    var nvae =
                        new ANTLR.runtime.NoViableAltException("67:10: fragment OCTAL_ESC : ( '\\\\' ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) );", 8, 1, this.input);
                ...
                var nvae =
                    new ANTLR.runtime.NoViableAltException("67:10: fragment OCTAL_ESC : ( '\\\\' ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) );", 8, 0, this.input);
    ...
    mDIGIT: function()  {
        try {
            // antlr/witty.g:75:17: ( '0' .. '9' )
            // antlr/witty.g:75:22: '0' .. '9'
            this.matchRange('0','9'); 
    ...
    mCR: function()  {
        try {
            // antlr/witty.g:77:14: ( ( '\\r' )? '\\n' )
            // antlr/witty.g:77:16: ( '\\r' )? '\\n'
            // antlr/witty.g:77:16: ( '\\r' )?
            var alt9=2;
