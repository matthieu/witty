// $ANTLR 3.0.1 antlr/witty.g 2008-07-08 21:07:53
...
ANTLR.lang.extend(wittyLexer, ANTLR.runtime.Lexer, {
    ...
    mNUM: function()  {
        try {
            this.type = this.NUM;
            // antlr/witty.g:64:11: ( ( DIGIT )+ ( '.' ( DIGIT )+ )? )
            // antlr/witty.g:64:13: ( DIGIT )+ ( '.' ( DIGIT )+ )?
            ...
            switch (alt6) {
                case 1 :
                    // antlr/witty.g:64:21: '.' ( DIGIT )+
                    this.match('.'); 
                    // antlr/witty.g:64:25: ( DIGIT )+
                    var cnt5=0;
                    loop5:
                    do {
                        var alt5=2;
    ...
    mESC_SEQ: function()  {
        try {
            ...
            if ( (LA9_0=='\\') ) {
                ...
                default:
                    var nvae =
                        new ANTLR.runtime.NoViableAltException("70:10: fragment ESC_SEQ : ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | UNICODE_ESC | OCTAL_ESC );", 9, 1, this.input);
                ...
                var nvae =
                    new ANTLR.runtime.NoViableAltException("70:10: fragment ESC_SEQ : ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | UNICODE_ESC | OCTAL_ESC );", 9, 0, this.input);
        ...
        try {
            ...
            if ( (LA10_0=='\\') ) {
                ...
                if ( ((LA10_1>='0' && LA10_1<='3')) ) {
                    ...
                    var nvae =
                        new ANTLR.runtime.NoViableAltException("71:10: fragment OCTAL_ESC : ( '\\\\' ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) );", 10, 1, this.input);
                ...
                var nvae =
                    new ANTLR.runtime.NoViableAltException("71:10: fragment OCTAL_ESC : ( '\\\\' ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) );", 10, 0, this.input);
    ...
    mDIGIT: function()  {
        try {
            // antlr/witty.g:79:19: ( '0' .. '9' )
            // antlr/witty.g:79:21: '0' .. '9'
            this.matchRange('0','9'); 
    ...
    mCR: function()  {
        try {
            // antlr/witty.g:81:19: ( ( '\\r' )? '\\n' )
            // antlr/witty.g:81:21: ( '\\r' )? '\\n'
            // antlr/witty.g:81:21: ( '\\r' )?
            var alt11=2;
