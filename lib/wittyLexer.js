// $ANTLR 3.0.1 antlr/witty.g 2008-07-06 19:54:17
...
ANTLR.lang.extend(wittyLexer, ANTLR.runtime.Lexer, {
    ...
    mOPER: function()  {
        try {
            this.type = this.OPER;
            // antlr/witty.g:60:11: ( ( SYMBOLS )+ )
            // antlr/witty.g:60:13: ( SYMBOLS )+
            // antlr/witty.g:60:13: ( SYMBOLS )+
            var cnt3=0;
            loop3:
            do {
    ...
    mNUM: function()  {
        try {
            this.type = this.NUM;
            // antlr/witty.g:61:11: ( ( DIGIT )+ ( '.' ( DIGIT )+ )? )
            // antlr/witty.g:61:13: ( DIGIT )+ ( '.' ( DIGIT )+ )?
            // antlr/witty.g:61:13: ( DIGIT )+
            var cnt4=0;
            loop4:
            do {
                var alt4=2;
            ...
            switch (alt6) {
                case 1 :
                    // antlr/witty.g:61:21: '.' ( DIGIT )+
                    this.match('.'); 
                    // antlr/witty.g:61:25: ( DIGIT )+
                    var cnt5=0;
                    loop5:
                    do {
                        var alt5=2;
    ...
    mCOMMENT: function()  {
        try {
            ...
            // antlr/witty.g:63:11: ( '//' ( . )* TERM )
            // antlr/witty.g:63:13: '//' ( . )* TERM
            this.match("//"); 
    ...
    mTERM: function()  {
        try {
            this.type = this.TERM;
            // antlr/witty.g:64:11: ( ( CR | ';' )+ )
            // antlr/witty.g:64:13: ( CR | ';' )+
            // antlr/witty.g:64:13: ( CR | ';' )+
            var cnt8=0;
            loop8:
            do {
    ...
    mESC_SEQ: function()  {
        try {
            // antlr/witty.g:67:23: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | UNICODE_ESC | OCTAL_ESC )
            var alt9=3;
            ...
            if ( (LA9_0=='\\') ) {
                ...
                default:
                    var nvae =
                        new ANTLR.runtime.NoViableAltException("67:10: fragment ESC_SEQ : ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | UNICODE_ESC | OCTAL_ESC );", 9, 1, this.input);
                ...
                var nvae =
                    new ANTLR.runtime.NoViableAltException("67:10: fragment ESC_SEQ : ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | UNICODE_ESC | OCTAL_ESC );", 9, 0, this.input);

                throw nvae;
            }
            switch (alt9) {
                case 1 :
                    // antlr/witty.g:67:27: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' )
                    this.match('\\'); 
                    ...
                    break;
                case 2 :
                    // antlr/witty.g:67:71: UNICODE_ESC
                    this.mUNICODE_ESC(); 


                    break;
                case 3 :
                    // antlr/witty.g:67:85: OCTAL_ESC
                    this.mOCTAL_ESC(); 
    ...
    mOCTAL_ESC: function()  {
        try {
            // antlr/witty.g:68:23: ( '\\\\' ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) )
            var alt10=3;
            ...
            if ( (LA10_0=='\\') ) {
                ...
                if ( ((LA10_1>='0' && LA10_1<='3')) ) {
                    ...
                    var nvae =
                        new ANTLR.runtime.NoViableAltException("68:10: fragment OCTAL_ESC : ( '\\\\' ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) );", 10, 1, this.input);
                ...
                var nvae =
                    new ANTLR.runtime.NoViableAltException("68:10: fragment OCTAL_ESC : ( '\\\\' ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) );", 10, 0, this.input);

                throw nvae;
            }
            switch (alt10) {
                case 1 :
                    // antlr/witty.g:68:25: '\\\\' ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' )
                    this.match('\\'); 
                    // antlr/witty.g:68:30: ( '0' .. '3' )
                    // antlr/witty.g:68:31: '0' .. '3'
                    this.matchRange('0','3'); 



                    // antlr/witty.g:68:41: ( '0' .. '7' )
                    // antlr/witty.g:68:42: '0' .. '7'
                    this.matchRange('0','7'); 



                    // antlr/witty.g:68:52: ( '0' .. '7' )
                    // antlr/witty.g:68:53: '0' .. '7'
                    this.matchRange('0','7'); 
                    ...
                    break;
                case 2 :
                    // antlr/witty.g:68:65: '\\\\' ( '0' .. '7' ) ( '0' .. '7' )
                    this.match('\\'); 
                    // antlr/witty.g:68:70: ( '0' .. '7' )
                    // antlr/witty.g:68:71: '0' .. '7'
                    this.matchRange('0','7'); 



                    // antlr/witty.g:68:81: ( '0' .. '7' )
                    // antlr/witty.g:68:82: '0' .. '7'
                    this.matchRange('0','7'); 
                    ...
                    break;
                case 3 :
                    // antlr/witty.g:68:94: '\\\\' ( '0' .. '7' )
                    this.match('\\'); 
                    // antlr/witty.g:68:99: ( '0' .. '7' )
                    // antlr/witty.g:68:100: '0' .. '7'
                    this.matchRange('0','7'); 
    ...
    mUNICODE_ESC: function()  {
        try {
            // antlr/witty.g:69:23: ( '\\\\' 'u' HEX_DIG HEX_DIG HEX_DIG HEX_DIG )
            // antlr/witty.g:69:27: '\\\\' 'u' HEX_DIG HEX_DIG HEX_DIG HEX_DIG
            this.match('\\'); 
            this.match('u'); 
            this.mHEX_DIG(); 
            this.mHEX_DIG(); 
    ...
    mHEX_DIG: function()  {
        try {
            // antlr/witty.g:70:23: ( ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' ) )
            // antlr/witty.g:70:25: ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' )
    ...
    mNON_OP: function()  {
        try {
            // antlr/witty.g:74:23: ( ( '_' | '~' | '@' | '#' | '$' | ':' | '?' | '`' ) )
            // antlr/witty.g:74:25: ( '_' | '~' | '@' | '#' | '$' | ':' | '?' | '`' )
    ...
    mDIGIT: function()  {
        try {
            // antlr/witty.g:76:19: ( '0' .. '9' )
            // antlr/witty.g:76:21: '0' .. '9'
            this.matchRange('0','9'); 
    ...
    mCR: function()  {
        try {
            // antlr/witty.g:78:19: ( ( '\\r' )? '\\n' )
            // antlr/witty.g:78:21: ( '\\r' )? '\\n'
            // antlr/witty.g:78:21: ( '\\r' )?
            var alt11=2;
