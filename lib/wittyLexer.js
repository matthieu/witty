// $ANTLR 3.0.1 antlr/witty.g 2008-07-25 22:36:04
...
ANTLR.lang.extend(wittyLexer, ANTLR.runtime.Lexer, {
    ...
    mOPER: function()  {
        try {
            this.type = this.OPER;
            // antlr/witty.g:68:5: ( SYMBOLS ( SYMBOLS | UNARY )* | UNARY ( SYMBOLS )+ )
            var alt3=2;
            ...
            if ( ((LA3_0>='#' && LA3_0<='&')||(LA3_0>='*' && LA3_0<='+')||(LA3_0>='.' && LA3_0<='/')||LA3_0==':'||(LA3_0>='<' && LA3_0<='@')||LA3_0=='\\'||(LA3_0>='^' && LA3_0<='`')||LA3_0=='|'||LA3_0=='~') ) {
                ...
                var nvae =
                    new ANTLR.runtime.NoViableAltException("68:1: OPER : ( SYMBOLS ( SYMBOLS | UNARY )* | UNARY ( SYMBOLS )+ );", 3, 0, this.input);

                throw nvae;
            }
            switch (alt3) {
                case 1 :
                    // antlr/witty.g:68:7: SYMBOLS ( SYMBOLS | UNARY )*
                    this.mSYMBOLS(); 
                    // antlr/witty.g:68:15: ( SYMBOLS | UNARY )*
                    loop1:
                    do {
                        var alt1=2;
                    ...
                    break;
                case 2 :
                    // antlr/witty.g:68:34: UNARY ( SYMBOLS )+
                    this.mUNARY(); 
                    // antlr/witty.g:68:40: ( SYMBOLS )+
                    var cnt2=0;
                    loop2:
                    do {
                        var alt2=2;
    ...
    mSYMBOLS: function()  {
        try {
            // antlr/witty.g:70:17: ( ( '_' | '~' | '@' | '#' | '$' | '%' | '^' | '&' | '<' | '>' | '*' | '+' | '=' | '|' | '\\\\' | ':' | '.' | '?' | '/' | '`' ) )
            // antlr/witty.g:70:19: ( '_' | '~' | '@' | '#' | '$' | '%' | '^' | '&' | '<' | '>' | '*' | '+' | '=' | '|' | '\\\\' | ':' | '.' | '?' | '/' | '`' )
    ...
    mID: function()  {
        try {
            ...
            do {
                ...
                if ( (LA4_0=='!'||(LA4_0>='#' && LA4_0<='$')||(LA4_0>='0' && LA4_0<=':')||(LA4_0>='?' && LA4_0<='Z')||(LA4_0>='_' && LA4_0<='z')||LA4_0=='~') ) {
                    alt4=1;
                }
    ...
    mCOMMENT: function()  {
        try {
            ...
            // antlr/witty.g:79:11: ( '//' ( . )* TERM )
            // antlr/witty.g:79:13: '//' ( . )* TERM
            this.match("//"); 
    ...
    mNON_OP: function()  {
        try {
            // antlr/witty.g:88:23: ( ( '_' | '~' | '@' | '#' | '$' | ':' | '?' | '`' ) )
            // antlr/witty.g:88:25: ( '_' | '~' | '@' | '#' | '$' | ':' | '?' | '`' )
    ...
    mDIGIT: function()  {
        try {
            // antlr/witty.g:90:19: ( '0' .. '9' )
            // antlr/witty.g:90:21: '0' .. '9'
            this.matchRange('0','9'); 
    ...
    mCR: function()  {
        try {
            // antlr/witty.g:92:19: ( ( '\\r' )? '\\n' )
            // antlr/witty.g:92:21: ( '\\r' )? '\\n'
            // antlr/witty.g:92:21: ( '\\r' )?
            var alt13=2;
