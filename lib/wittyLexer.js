// $ANTLR 3.0.1 antlr/witty.g 2008-07-03 21:46:05
...
ANTLR.lang.extend(wittyLexer, ANTLR.runtime.Lexer, {
    ...
    mID: function()  {
        try {
            this.type = this.ID;
            // antlr/witty.g:38:11: ( ( LETTER | NON_OP )* )
            // antlr/witty.g:38:13: ( LETTER | NON_OP )*
            // antlr/witty.g:38:13: ( LETTER | NON_OP )*
            loop1:
            do {
                var alt1=2;
                ...
                if ( (LA1_0=='!'||(LA1_0>='#' && LA1_0<='$')||LA1_0=='.'||LA1_0==':'||(LA1_0>='?' && LA1_0<='Z')||LA1_0=='_'||(LA1_0>='a' && LA1_0<='z')||LA1_0=='~') ) {
                    alt1=1;
                }
    ...
    mSTRING: function()  {
        try {
            ...
            // antlr/witty.g:39:11: ( '\"' ( ESC_SEQ | ~ ( '\\\\' | '\"' ) )* '\"' )
            // antlr/witty.g:39:14: '\"' ( ESC_SEQ | ~ ( '\\\\' | '\"' ) )* '\"'
            this.match('\"'); 
            // antlr/witty.g:39:18: ( ESC_SEQ | ~ ( '\\\\' | '\"' ) )*
            loop2:
            do {
                var alt2=3;
    ...
    mOPER: function()  {
        try {
            this.type = this.OPER;
            // antlr/witty.g:40:11: ( ( SYMBOLS )+ )
            // antlr/witty.g:40:13: ( SYMBOLS )+
            // antlr/witty.g:40:13: ( SYMBOLS )+
            var cnt3=0;
            loop3:
            do {
    ...
    mINNT: function()  {
        try {
            this.type = this.INNT;
            // antlr/witty.g:41:11: ( ( DIGIT )+ )
            // antlr/witty.g:41:13: ( DIGIT )+
            // antlr/witty.g:41:13: ( DIGIT )+
            var cnt4=0;
            loop4:
            do {
    ...
    mCOMMENT: function()  {
        try {
            ...
            // antlr/witty.g:43:11: ( '//' ( . )* TERM )
            // antlr/witty.g:43:13: '//' ( . )* TERM
            this.match("//"); 
    ...
    mTERM: function()  {
        try {
            this.type = this.TERM;
            // antlr/witty.g:44:11: ( ( CR | ';' )+ )
            // antlr/witty.g:44:13: ( CR | ';' )+
            // antlr/witty.g:44:13: ( CR | ';' )+
            var cnt6=0;
            loop6:
            do {
    ...
    mESC_SEQ: function()  {
        try {
            // antlr/witty.g:47:23: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | UNICODE_ESC | OCTAL_ESC )
            var alt7=3;
            ...
            if ( (LA7_0=='\\') ) {
                ...
                default:
                    var nvae =
                        new ANTLR.runtime.NoViableAltException("47:10: fragment ESC_SEQ : ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | UNICODE_ESC | OCTAL_ESC );", 7, 1, this.input);
                ...
                var nvae =
                    new ANTLR.runtime.NoViableAltException("47:10: fragment ESC_SEQ : ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | UNICODE_ESC | OCTAL_ESC );", 7, 0, this.input);

                throw nvae;
            }
            switch (alt7) {
                case 1 :
                    // antlr/witty.g:47:27: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' )
                    this.match('\\'); 
                    ...
                    break;
                case 2 :
                    // antlr/witty.g:47:71: UNICODE_ESC
                    this.mUNICODE_ESC(); 


                    break;
                case 3 :
                    // antlr/witty.g:47:85: OCTAL_ESC
                    this.mOCTAL_ESC(); 
    ...
    mOCTAL_ESC: function()  {
        try {
            // antlr/witty.g:48:23: ( '\\\\' ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) )
            var alt8=3;
            ...
            if ( (LA8_0=='\\') ) {
                ...
                if ( ((LA8_1>='0' && LA8_1<='3')) ) {
                    ...
                    var nvae =
                        new ANTLR.runtime.NoViableAltException("48:10: fragment OCTAL_ESC : ( '\\\\' ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) );", 8, 1, this.input);
                ...
                var nvae =
                    new ANTLR.runtime.NoViableAltException("48:10: fragment OCTAL_ESC : ( '\\\\' ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) );", 8, 0, this.input);

                throw nvae;
            }
            switch (alt8) {
                case 1 :
                    // antlr/witty.g:48:25: '\\\\' ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' )
                    this.match('\\'); 
                    // antlr/witty.g:48:30: ( '0' .. '3' )
                    // antlr/witty.g:48:31: '0' .. '3'
                    this.matchRange('0','3'); 



                    // antlr/witty.g:48:41: ( '0' .. '7' )
                    // antlr/witty.g:48:42: '0' .. '7'
                    this.matchRange('0','7'); 



                    // antlr/witty.g:48:52: ( '0' .. '7' )
                    // antlr/witty.g:48:53: '0' .. '7'
                    this.matchRange('0','7'); 
                    ...
                    break;
                case 2 :
                    // antlr/witty.g:48:65: '\\\\' ( '0' .. '7' ) ( '0' .. '7' )
                    this.match('\\'); 
                    // antlr/witty.g:48:70: ( '0' .. '7' )
                    // antlr/witty.g:48:71: '0' .. '7'
                    this.matchRange('0','7'); 



                    // antlr/witty.g:48:81: ( '0' .. '7' )
                    // antlr/witty.g:48:82: '0' .. '7'
                    this.matchRange('0','7'); 
                    ...
                    break;
                case 3 :
                    // antlr/witty.g:48:94: '\\\\' ( '0' .. '7' )
                    this.match('\\'); 
                    // antlr/witty.g:48:99: ( '0' .. '7' )
                    // antlr/witty.g:48:100: '0' .. '7'
                    this.matchRange('0','7'); 
    ...
    mUNICODE_ESC: function()  {
        try {
            // antlr/witty.g:49:23: ( '\\\\' 'u' HEX_DIG HEX_DIG HEX_DIG HEX_DIG )
            // antlr/witty.g:49:27: '\\\\' 'u' HEX_DIG HEX_DIG HEX_DIG HEX_DIG
            this.match('\\'); 
            this.match('u'); 
            this.mHEX_DIG(); 
            this.mHEX_DIG(); 
    ...
    mHEX_DIG: function()  {
        try {
            // antlr/witty.g:50:23: ( ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' ) )
            // antlr/witty.g:50:25: ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' )
    ...
    mSYMBOLS: function()  {
        try {
            // antlr/witty.g:52:23: ( ( '_' | '-' | '~' | '!' | '@' | '#' | '$' | '%' | '^' | '&' | '<' | '>' | '*' | '+' | '=' | '|' | '\\\\' | ':' | '.' | '?' | '/' ) )
            // antlr/witty.g:52:25: ( '_' | '-' | '~' | '!' | '@' | '#' | '$' | '%' | '^' | '&' | '<' | '>' | '*' | '+' | '=' | '|' | '\\\\' | ':' | '.' | '?' | '/' )
    ...
    mNON_OP: function()  {
        try {
            // antlr/witty.g:54:23: ( ( '_' | '~' | '!' | '@' | '#' | '$' | ':' | '.' | '?' ) )
            // antlr/witty.g:54:25: ( '_' | '~' | '!' | '@' | '#' | '$' | ':' | '.' | '?' )
    ...
    mDIGIT: function()  {
        try {
            // antlr/witty.g:56:17: ( '0' .. '9' )
            // antlr/witty.g:56:22: '0' .. '9'
            this.matchRange('0','9'); 
    ...
    mCR: function()  {
        try {
            // antlr/witty.g:58:14: ( ( '\\r' )? '\\n' )
            // antlr/witty.g:58:16: ( '\\r' )? '\\n'
            // antlr/witty.g:58:16: ( '\\r' )?
            var alt9=2;
