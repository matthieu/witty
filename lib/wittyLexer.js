// $ANTLR 3.0.1 antlr/witty.g 2008-07-06 09:15:05
...
ANTLR.lang.extend(wittyLexer, ANTLR.runtime.Lexer, {
    ...
    mID: function()  {
        try {
            this.type = this.ID;
            // antlr/witty.g:56:11: ( ( LETTER | NON_OP ) ( LETTER | DIGIT | NON_OP | '!' )* )
            // antlr/witty.g:56:13: ( LETTER | NON_OP ) ( LETTER | DIGIT | NON_OP | '!' )*
            if ( (this.input.LA(1)>='#' && this.input.LA(1)<='$')||this.input.LA(1)=='.'||this.input.LA(1)==':'||(this.input.LA(1)>='?' && this.input.LA(1)<='Z')||(this.input.LA(1)>='_' && this.input.LA(1)<='z')||this.input.LA(1)=='~' ) {
                this.input.consume();
            ...
            // antlr/witty.g:56:31: ( LETTER | DIGIT | NON_OP | '!' )*
            loop1:
            do {
                var alt1=2;
                var LA1_0 = this.input.LA(1);

                if ( (LA1_0=='!'||(LA1_0>='#' && LA1_0<='$')||LA1_0=='.'||(LA1_0>='0' && LA1_0<=':')||(LA1_0>='?' && LA1_0<='Z')||(LA1_0>='_' && LA1_0<='z')||LA1_0=='~') ) {
                    alt1=1;
                }
            	...
            	case 1 :
            	    // antlr/witty.g:
            	    if ( this.input.LA(1)=='!'||(this.input.LA(1)>='#' && this.input.LA(1)<='$')||this.input.LA(1)=='.'||(this.input.LA(1)>='0' && this.input.LA(1)<=':')||(this.input.LA(1)>='?' && this.input.LA(1)<='Z')||(this.input.LA(1)>='_' && this.input.LA(1)<='z')||this.input.LA(1)=='~' ) {
            	        this.input.consume();
    ...
    mSTRING: function()  {
        try {
            ...
            // antlr/witty.g:57:11: ( '\"' ( ESC_SEQ | ~ ( '\\\\' | '\"' ) )* '\"' )
            // antlr/witty.g:57:14: '\"' ( ESC_SEQ | ~ ( '\\\\' | '\"' ) )* '\"'
            this.match('\"'); 
            // antlr/witty.g:57:18: ( ESC_SEQ | ~ ( '\\\\' | '\"' ) )*
            loop2:
            do {
                var alt2=3;
    ...
    mOPER: function()  {
        try {
            this.type = this.OPER;
            // antlr/witty.g:58:11: ( ( SYMBOLS )+ )
            // antlr/witty.g:58:13: ( SYMBOLS )+
            // antlr/witty.g:58:13: ( SYMBOLS )+
            var cnt3=0;
            loop3:
            do {
    ...
    mINNT: function()  {
        try {
            this.type = this.INNT;
            // antlr/witty.g:59:11: ( ( DIGIT )+ )
            // antlr/witty.g:59:13: ( DIGIT )+
            // antlr/witty.g:59:13: ( DIGIT )+
            var cnt4=0;
            loop4:
            do {
    ...
    mCOMMENT: function()  {
        try {
            ...
            // antlr/witty.g:61:11: ( '//' ( . )* TERM )
            // antlr/witty.g:61:13: '//' ( . )* TERM
            this.match("//"); 
    ...
    mESC_SEQ: function()  {
        try {
            // antlr/witty.g:65:23: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | UNICODE_ESC | OCTAL_ESC )
            var alt7=3;
            ...
            if ( (LA7_0=='\\') ) {
                ...
                default:
                    var nvae =
                        new ANTLR.runtime.NoViableAltException("65:10: fragment ESC_SEQ : ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | UNICODE_ESC | OCTAL_ESC );", 7, 1, this.input);
                ...
                var nvae =
                    new ANTLR.runtime.NoViableAltException("65:10: fragment ESC_SEQ : ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | UNICODE_ESC | OCTAL_ESC );", 7, 0, this.input);

                throw nvae;
            }
            switch (alt7) {
                case 1 :
                    // antlr/witty.g:65:27: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' )
                    this.match('\\'); 
                    ...
                    break;
                case 2 :
                    // antlr/witty.g:65:71: UNICODE_ESC
                    this.mUNICODE_ESC(); 


                    break;
                case 3 :
                    // antlr/witty.g:65:85: OCTAL_ESC
                    this.mOCTAL_ESC(); 
    ...
    mOCTAL_ESC: function()  {
        try {
            // antlr/witty.g:66:23: ( '\\\\' ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) )
            var alt8=3;
            ...
            if ( (LA8_0=='\\') ) {
                ...
                if ( ((LA8_1>='0' && LA8_1<='3')) ) {
                    ...
                    var nvae =
                        new ANTLR.runtime.NoViableAltException("66:10: fragment OCTAL_ESC : ( '\\\\' ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) );", 8, 1, this.input);
                ...
                var nvae =
                    new ANTLR.runtime.NoViableAltException("66:10: fragment OCTAL_ESC : ( '\\\\' ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) );", 8, 0, this.input);

                throw nvae;
            }
            switch (alt8) {
                case 1 :
                    // antlr/witty.g:66:25: '\\\\' ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' )
                    this.match('\\'); 
                    // antlr/witty.g:66:30: ( '0' .. '3' )
                    // antlr/witty.g:66:31: '0' .. '3'
                    this.matchRange('0','3'); 



                    // antlr/witty.g:66:41: ( '0' .. '7' )
                    // antlr/witty.g:66:42: '0' .. '7'
                    this.matchRange('0','7'); 



                    // antlr/witty.g:66:52: ( '0' .. '7' )
                    // antlr/witty.g:66:53: '0' .. '7'
                    this.matchRange('0','7'); 
                    ...
                    break;
                case 2 :
                    // antlr/witty.g:66:65: '\\\\' ( '0' .. '7' ) ( '0' .. '7' )
                    this.match('\\'); 
                    // antlr/witty.g:66:70: ( '0' .. '7' )
                    // antlr/witty.g:66:71: '0' .. '7'
                    this.matchRange('0','7'); 



                    // antlr/witty.g:66:81: ( '0' .. '7' )
                    // antlr/witty.g:66:82: '0' .. '7'
                    this.matchRange('0','7'); 
                    ...
                    break;
                case 3 :
                    // antlr/witty.g:66:94: '\\\\' ( '0' .. '7' )
                    this.match('\\'); 
                    // antlr/witty.g:66:99: ( '0' .. '7' )
                    // antlr/witty.g:66:100: '0' .. '7'
                    this.matchRange('0','7'); 
    ...
    mUNICODE_ESC: function()  {
        try {
            // antlr/witty.g:67:23: ( '\\\\' 'u' HEX_DIG HEX_DIG HEX_DIG HEX_DIG )
            // antlr/witty.g:67:27: '\\\\' 'u' HEX_DIG HEX_DIG HEX_DIG HEX_DIG
            this.match('\\'); 
            this.match('u'); 
            this.mHEX_DIG(); 
            this.mHEX_DIG(); 
    ...
    mHEX_DIG: function()  {
        try {
            // antlr/witty.g:68:23: ( ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' ) )
            // antlr/witty.g:68:25: ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' )
    ...
    mSYMBOLS: function()  {
        try {
            // antlr/witty.g:70:23: ( ( '_' | '-' | '~' | '!' | '@' | '#' | '$' | '%' | '^' | '&' | '<' | '>' | '*' | '+' | '=' | '|' | '\\\\' | ':' | '.' | '?' | '/' | '`' ) )
            // antlr/witty.g:70:25: ( '_' | '-' | '~' | '!' | '@' | '#' | '$' | '%' | '^' | '&' | '<' | '>' | '*' | '+' | '=' | '|' | '\\\\' | ':' | '.' | '?' | '/' | '`' )
    ...
    mNON_OP: function()  {
        try {
            // antlr/witty.g:72:23: ( ( '_' | '~' | '@' | '#' | '$' | ':' | '.' | '?' | '`' ) )
            // antlr/witty.g:72:25: ( '_' | '~' | '@' | '#' | '$' | ':' | '.' | '?' | '`' )
            if ( (this.input.LA(1)>='#' && this.input.LA(1)<='$')||this.input.LA(1)=='.'||this.input.LA(1)==':'||(this.input.LA(1)>='?' && this.input.LA(1)<='@')||(this.input.LA(1)>='_' && this.input.LA(1)<='`')||this.input.LA(1)=='~' ) {
                this.input.consume();
    ...
    mDIGIT: function()  {
        try {
            // antlr/witty.g:74:17: ( '0' .. '9' )
            // antlr/witty.g:74:22: '0' .. '9'
            this.matchRange('0','9'); 
    ...
    mCR: function()  {
        try {
            // antlr/witty.g:76:14: ( ( '\\r' )? '\\n' )
            // antlr/witty.g:76:16: ( '\\r' )? '\\n'
            // antlr/witty.g:76:16: ( '\\r' )?
            var alt9=2;
