// $ANTLR 3.0.1 antlr/witty.g 2008-07-25 22:36:03
  ...
  function flattenArrays(arr) {
    //print("flatten: " + JSON.stringify(arr));
    var mod = [];
    mod.sntx = arr.sntx;
    for (var m = 0; m < arr.length; m++) {
      var elmt = arr[m];
      if (elmt.sntx)
        mod.push(flattenArrays(elmt));
      else if (elmt instanceof Array)
        mod = mod.concat(flattenArrays(elmt));
      else 
        mod.push(elmt);
    }
    //print("flattened: " + JSON.stringify(mod));
    return mod;
  }
...
ANTLR.lang.extend(wittyParser, ANTLR.runtime.Parser, {
    ...
    // antlr/witty.g:29:1: block returns [Object val] : ( TERM )* s1= stmt ( ( TERM )+ s2= stmt )* ( TERM )* ( EOF )? ;
    // $ANTLR start block
    block: function() {
        var val = null;
        ...
        try {
            // antlr/witty.g:30:21: ( ( TERM )* s1= stmt ( ( TERM )+ s2= stmt )* ( TERM )* ( EOF )? )
            // antlr/witty.g:30:23: ( TERM )* s1= stmt ( ( TERM )+ s2= stmt )* ( TERM )* ( EOF )?
            // antlr/witty.g:30:23: ( TERM )*
            loop1:
            do {
                var alt1=2;
            ...
            // antlr/witty.g:33:23: ( ( TERM )+ s2= stmt )*
            loop3:
            do {
                var alt3=2;
                ...
                switch (alt3) {
            	case 1 :
            	    // antlr/witty.g:33:24: ( TERM )+ s2= stmt
            	    // antlr/witty.g:33:24: ( TERM )+
            	    var cnt2=0;
            	    loop2:
            	    do {
            	        var alt2=2;
    ...
    // antlr/witty.g:37:1: stmt returns [Object val] : ( WS )* as= assoc ( WS )* ;
    // $ANTLR start stmt
    stmt: function() {
        var val = null;
        ...
        try {
            // antlr/witty.g:38:21: ( ( WS )* as= assoc ( WS )* )
            // antlr/witty.g:38:23: ( WS )* as= assoc ( WS )*
            // antlr/witty.g:38:23: ( WS )*
            loop6:
            do {
                var alt6=2;
    ...
    // antlr/witty.g:40:1: assoc returns [Object val] : (p= parens_assoc | am= atom_assoc );
    // $ANTLR start assoc
    assoc: function() {
        var val = null;
        ...
        try {
            // antlr/witty.g:41:21: (p= parens_assoc | am= atom_assoc )
            var alt8=2;
            ...
            if ( (LA8_0==21) ) {
                ...
                if (this.backtracking>0) {this.failed=true; return val;}
                var nvae =
                    new ANTLR.runtime.NoViableAltException("40:1: assoc returns [Object val] : (p= parens_assoc | am= atom_assoc );", 8, 0, this.input);

                throw nvae;
            }
            switch (alt8) {
                case 1 :
                    // antlr/witty.g:41:23: p= parens_assoc
                    ...
                    break;
                case 2 :
                    // antlr/witty.g:42:25: am= atom_assoc
    ...
    // antlr/witty.g:44:1: parens_assoc returns [Object val] : '(' s1= stmt ')' (op= ( OPER | UNARY ) s2= stmt )? ;
    ...
    parens_assoc: function() {
        ...
        try {
            // antlr/witty.g:45:21: ( '(' s1= stmt ')' (op= ( OPER | UNARY ) s2= stmt )? )
            // antlr/witty.g:45:23: '(' s1= stmt ')' (op= ( OPER | UNARY ) s2= stmt )?
            ...
            // antlr/witty.g:45:39: (op= ( OPER | UNARY ) s2= stmt )?
            var alt9=2;
            ...
            switch (alt9) {
                case 1 :
                    // antlr/witty.g:45:40: op= ( OPER | UNARY ) s2= stmt
                    op=this.input.LT(1);
    ...
    // antlr/witty.g:48:1: atom_assoc returns [Object val] : ( ( UNARY applic )=>u1= UNARY p1= applic | ( applic )=>p2= applic | ( UNARY atom )=>u2= UNARY a1= atom | a2= atom ) (op= ( OPER | UNARY ) stmt )? ;
    ...
    atom_assoc: function() {
        ...
        try {
            // antlr/witty.g:49:21: ( ( ( UNARY applic )=>u1= UNARY p1= applic | ( applic )=>p2= applic | ( UNARY atom )=>u2= UNARY a1= atom | a2= atom ) (op= ( OPER | UNARY ) stmt )? )
            // antlr/witty.g:49:23: ( ( UNARY applic )=>u1= UNARY p1= applic | ( applic )=>p2= applic | ( UNARY atom )=>u2= UNARY a1= atom | a2= atom ) (op= ( OPER | UNARY ) stmt )?
            // antlr/witty.g:49:23: ( ( UNARY applic )=>u1= UNARY p1= applic | ( applic )=>p2= applic | ( UNARY atom )=>u2= UNARY a1= atom | a2= atom )
            var alt10=4;
            alt10 = this.dfa10.predict(this.input);
            switch (alt10) {
                case 1 :
                    // antlr/witty.g:49:24: ( UNARY applic )=>u1= UNARY p1= applic
                    u1=this.input.LT(1);
                    ...
                    break;
                case 2 :
                    // antlr/witty.g:50:25: ( applic )=>p2= applic
                    ...
                    break;
                case 3 :
                    // antlr/witty.g:51:25: ( UNARY atom )=>u2= UNARY a1= atom
                    u2=this.input.LT(1);
            ...
            // antlr/witty.g:53:23: (op= ( OPER | UNARY ) stmt )?
            var alt11=2;
            ...
            switch (alt11) {
                case 1 :
                    // antlr/witty.g:53:24: op= ( OPER | UNARY ) stmt
                    op=this.input.LT(1);
                    if ( (this.input.LA(1)>=OPER && this.input.LA(1)<=UNARY) ) {
                        this.input.consume();
                        this.errorRecovery=false;this.failed=false;
    ...
    // antlr/witty.g:55:1: atom returns [Object val] : (a= ( NUM | STRING ) | tokn );
    // $ANTLR start atom
    atom: function() {
        var val = null;
        ...
        try {
            // antlr/witty.g:56:22: (a= ( NUM | STRING ) | tokn )
            var alt12=2;
            ...
            if ( ((LA12_0>=NUM && LA12_0<=STRING)) ) {
                ...
                if (this.backtracking>0) {this.failed=true; return val;}
                var nvae =
                    new ANTLR.runtime.NoViableAltException("55:1: atom returns [Object val] : (a= ( NUM | STRING ) | tokn );", 12, 0, this.input);

                throw nvae;
            }
            switch (alt12) {
                case 1 :
                    // antlr/witty.g:56:24: a= ( NUM | STRING )
                    a=this.input.LT(1);
    ...
    // antlr/witty.g:59:1: applic returns [Object val] : tokn ( '(' (b1= block )? ( ',' b2= block )* ')' )+ ;
    // $ANTLR start applic
    applic: function() {
        var val = null;
        ...
        try {
            // antlr/witty.g:60:21: ( tokn ( '(' (b1= block )? ( ',' b2= block )* ')' )+ )
            // antlr/witty.g:60:23: tokn ( '(' (b1= block )? ( ',' b2= block )* ')' )+
            ...
            // antlr/witty.g:61:23: ( '(' (b1= block )? ( ',' b2= block )* ')' )+
            var cnt15=0;
            loop15:
            do {
                var alt15=2;
                ...
                switch (alt15) {
            	case 1 :
            	    // antlr/witty.g:61:25: '(' (b1= block )? ( ',' b2= block )* ')'
            	    if ( this.backtracking===0 ) {
    ...
    // antlr/witty.g:65:1: tokn returns [Object val] : t= ( ID | OPER | UNARY ) ;
    // $ANTLR start tokn
    tokn: function() {
        ...
        try {
            // antlr/witty.g:66:21: (t= ( ID | OPER | UNARY ) )
            // antlr/witty.g:66:23: t= ( ID | OPER | UNARY )
            t=this.input.LT(1);
    ...
    synpred1_fragment: function() {   
        // antlr/witty.g:49:24: ( UNARY applic )
        // antlr/witty.g:49:25: UNARY applic
    ...
    synpred2_fragment: function() {   
        // antlr/witty.g:50:25: ( applic )
        // antlr/witty.g:50:26: applic
    ...
    synpred3_fragment: function() {   
        // antlr/witty.g:51:25: ( UNARY atom )
        // antlr/witty.g:51:26: UNARY atom
...
ANTLR.lang.extend(wittyParser.DFA3, ANTLR.runtime.DFA, {
    getDescription: function() {
        return "()* loopback of 33:23: ( ( TERM )+ s2= stmt )*";
    },
    dummy: null
});
ANTLR.lang.augmentObject(wittyParser, {
...
ANTLR.lang.extend(wittyParser.DFA10, ANTLR.runtime.DFA, {
    getDescription: function() {
        return "49:23: ( ( UNARY applic )=>u1= UNARY p1= applic | ( applic )=>p2= applic | ( UNARY atom )=>u2= UNARY a1= atom | a2= atom )";
    },
...
// public class variables
ANTLR.lang.augmentObject(wittyParser, {
    tokenNames: ["<invalid>", "<EOR>", "<DOWN>", "<UP>", "TERM", "WS", "OPER", "UNARY", "NUM", "STRING", "ID", "SYMBOLS", "LETTER", "NON_OP", "DIGIT", "ESC_SEQ", "COMMENT", "CR", "UNICODE_ESC", "OCTAL_ESC", "HEX_DIG", "'('", "')'", "','"],
