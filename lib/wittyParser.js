// $ANTLR 3.0.1 antlr/witty.g 2008-07-06 12:13:36
...
ANTLR.lang.extend(wittyParser, ANTLR.runtime.Parser, {
    ...
    // antlr/witty.g:26:1: exp returns [Object val] : ( ( OPER unary_list )=> OPER u= unary_list | ( atom ( list )+ )=> applic | atom | unary_list );
    // $ANTLR start exp
    exp: function() {
        var val = null;
        ...
        try {
            // antlr/witty.g:27:21: ( ( OPER unary_list )=> OPER u= unary_list | ( atom ( list )+ )=> applic | atom | unary_list )
            var alt7=4;
            ...
            case OPER:
                ...
                if ( (this.synpred7()) ) {
                    ...
                    if (this.backtracking>0) {this.failed=true; return val;}
                    var nvae =
                        new ANTLR.runtime.NoViableAltException("26:1: exp returns [Object val] : ( ( OPER unary_list )=> OPER u= unary_list | ( atom ( list )+ )=> applic | atom | unary_list );", 7, 1, this.input);
            ...
            case ID:
                ...
                if ( (this.synpred9()) ) {
                    ...
                    if (this.backtracking>0) {this.failed=true; return val;}
                    var nvae =
                        new ANTLR.runtime.NoViableAltException("26:1: exp returns [Object val] : ( ( OPER unary_list )=> OPER u= unary_list | ( atom ( list )+ )=> applic | atom | unary_list );", 7, 2, this.input);
            ...
            case NUM:
                ...
                if ( (this.synpred9()) ) {
                    ...
                    if (this.backtracking>0) {this.failed=true; return val;}
                    var nvae =
                        new ANTLR.runtime.NoViableAltException("26:1: exp returns [Object val] : ( ( OPER unary_list )=> OPER u= unary_list | ( atom ( list )+ )=> applic | atom | unary_list );", 7, 3, this.input);
            ...
            case STRING:
                ...
                if ( (this.synpred9()) ) {
                    ...
                    if (this.backtracking>0) {this.failed=true; return val;}
                    var nvae =
                        new ANTLR.runtime.NoViableAltException("26:1: exp returns [Object val] : ( ( OPER unary_list )=> OPER u= unary_list | ( atom ( list )+ )=> applic | atom | unary_list );", 7, 4, this.input);
            ...
            default:
                if (this.backtracking>0) {this.failed=true; return val;}
                var nvae =
                    new ANTLR.runtime.NoViableAltException("26:1: exp returns [Object val] : ( ( OPER unary_list )=> OPER u= unary_list | ( atom ( list )+ )=> applic | atom | unary_list );", 7, 0, this.input);
            ...
            switch (alt7) {
                ...
                case 4 :
                    ...
                    this.pushFollow(wittyParser.FOLLOW_unary_list_in_exp289);
    ...
    applic: function() {
        ...
        try {
            ...
            this.pushFollow(wittyParser.FOLLOW_atom_in_applic302);
            var atom5 = this.atom();
            this._fsp--;
            if (this.failed) return val;
            if ( this.backtracking===0 ) {
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    this.pushFollow(wittyParser.FOLLOW_list_in_applic330);
            	    var list6 = this.list();
            	    this._fsp--;
            	    if (this.failed) return val;
            	    if ( this.backtracking===0 ) {
        ...
        try {
            ...
            if ( (LA9_0==20) ) {
                ...
                if ( (this.synpred12()) ) {
                    ...
                    if (this.backtracking>0) {this.failed=true; return val;}
                    var nvae =
                        new ANTLR.runtime.NoViableAltException("36:1: list returns [Object val] : ( empty_list | unary_list | multi_list );", 9, 1, this.input);
                ...
                if (this.backtracking>0) {this.failed=true; return val;}
                var nvae =
                    new ANTLR.runtime.NoViableAltException("36:1: list returns [Object val] : ( empty_list | unary_list | multi_list );", 9, 0, this.input);
            ...
            switch (alt9) {
                case 1 :
                    ...
                    this.pushFollow(wittyParser.FOLLOW_empty_list_in_list345);
                ...
                case 2 :
                    ...
                    this.pushFollow(wittyParser.FOLLOW_unary_list_in_list373);
                ...
                case 3 :
                    ...
                    this.pushFollow(wittyParser.FOLLOW_multi_list_in_list401);
    ...
    empty_list: function() {
        ...
        try {
            // antlr/witty.g:42:21: ( '(' ')' )
            // antlr/witty.g:42:23: '(' ')'
            this.match(this.input,20,wittyParser.FOLLOW_20_in_empty_list414); if (this.failed) return val;
            this.match(this.input,21,wittyParser.FOLLOW_21_in_empty_list416); if (this.failed) return val;
            if ( this.backtracking===0 ) {
               val = []; val.sntx = 'B'; 
            }
    ...
    unary_list: function() {
        ...
        try {
            ...
            this.match(this.input,20,wittyParser.FOLLOW_20_in_unary_list429); if (this.failed) return val;
            this.pushFollow(wittyParser.FOLLOW_block_in_unary_list431);
            var block10 = this.block();
            this._fsp--;
            if (this.failed) return val;
            this.match(this.input,21,wittyParser.FOLLOW_21_in_unary_list433); if (this.failed) return val;
            if ( this.backtracking===0 ) {
    ...
    multi_list: function() {
        ...
        try {
            ...
            this.match(this.input,20,wittyParser.FOLLOW_20_in_multi_list446); if (this.failed) return val;
            this.pushFollow(wittyParser.FOLLOW_block_in_multi_list450);
            var b1 = this.block();
            this._fsp--;
            if (this.failed) return val;
            if ( this.backtracking===0 ) {
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    this.match(this.input,22,wittyParser.FOLLOW_22_in_multi_list478); if (this.failed) return val;
            	    this.pushFollow(wittyParser.FOLLOW_block_in_multi_list482);
            	    var b2 = this.block();
            	    this._fsp--;
            	    if (this.failed) return val;
            	    if ( this.backtracking===0 ) {
            ...
            this.match(this.input,21,wittyParser.FOLLOW_21_in_multi_list489); if (this.failed) return val;
    ...
    // antlr/witty.g:52:1: atom returns [Object val] : ( ID | NUM | STRING | OPER );
    // $ANTLR start atom
    atom: function() {
        var val = null;
        ...
        try {
            // antlr/witty.g:53:21: ( ID | NUM | STRING | OPER )
            var alt11=4;
            switch ( this.input.LA(1) ) {
            case ID:
                alt11=1;
            ...
            default:
                if (this.backtracking>0) {this.failed=true; return val;}
                var nvae =
                    new ANTLR.runtime.NoViableAltException("52:1: atom returns [Object val] : ( ID | NUM | STRING | OPER );", 11, 0, this.input);
            ...
            switch (alt11) {
                case 1 :
                    ...
                    this.match(this.input,ID,wittyParser.FOLLOW_ID_in_atom500); if (this.failed) return val;
                    if ( this.backtracking===0 ) {
                       val = ID11.getText(); 
                    }
                    ...
                    break;
                case 2 :
                    // antlr/witty.g:53:49: NUM
                    NUM12=this.input.LT(1);
                    this.match(this.input,NUM,wittyParser.FOLLOW_NUM_in_atom506); if (this.failed) return val;
                    if ( this.backtracking===0 ) {
                       val = NUM12.getText(); 
                    }
                ...
                case 3 :
                    ...
                    this.match(this.input,STRING,wittyParser.FOLLOW_STRING_in_atom535); if (this.failed) return val;
                    if ( this.backtracking===0 ) {
                ...
                case 4 :
                    ...
                    this.match(this.input,OPER,wittyParser.FOLLOW_OPER_in_atom541); if (this.failed) return val;
                    if ( this.backtracking===0 ) {
                       val = OPER14.getText(); 
                    }
    ...
    synpred10_fragment: function() {   
        // antlr/witty.g:29:25: ( atom )
        // antlr/witty.g:29:25: atom
        this.pushFollow(wittyParser.FOLLOW_atom_in_synpred10261);
        this.atom();
        this._fsp--;
        if (this.failed) return ;
    ...
    synpred11_fragment: function() {   
        // antlr/witty.g:34:24: ( list )
        // antlr/witty.g:34:24: list
        this.pushFollow(wittyParser.FOLLOW_list_in_synpred11330);
        this.list();
        this._fsp--;
        if (this.failed) return ;
    ...
    synpred12_fragment: function() {   
        // antlr/witty.g:37:23: ( empty_list )
        // antlr/witty.g:37:23: empty_list
        this.pushFollow(wittyParser.FOLLOW_empty_list_in_synpred12345);
        this.empty_list();
        this._fsp--;
        if (this.failed) return ;
    ...
    synpred13_fragment: function() {   
        // antlr/witty.g:38:25: ( unary_list )
        // antlr/witty.g:38:25: unary_list
        this.pushFollow(wittyParser.FOLLOW_unary_list_in_synpred13373);
        this.unary_list();
        this._fsp--;
        if (this.failed) return ;
...
ANTLR.lang.augmentObject(wittyParser, {
    ...
    FOLLOW_unary_list_in_exp289: new ANTLR.misc.BitSet([0x00000002,0x00000000]),
    FOLLOW_atom_in_applic302: new ANTLR.misc.BitSet([0x00100000,0x00000000]),
    FOLLOW_list_in_applic330: new ANTLR.misc.BitSet([0x00100002,0x00000000]),
    FOLLOW_empty_list_in_list345: new ANTLR.misc.BitSet([0x00000002,0x00000000]),
    FOLLOW_unary_list_in_list373: new ANTLR.misc.BitSet([0x00000002,0x00000000]),
    FOLLOW_multi_list_in_list401: new ANTLR.misc.BitSet([0x00000002,0x00000000]),
    FOLLOW_20_in_empty_list414: new ANTLR.misc.BitSet([0x00200000,0x00000000]),
    FOLLOW_21_in_empty_list416: new ANTLR.misc.BitSet([0x00000002,0x00000000]),
    FOLLOW_20_in_unary_list429: new ANTLR.misc.BitSet([0x001001F0,0x00000000]),
    FOLLOW_block_in_unary_list431: new ANTLR.misc.BitSet([0x00200000,0x00000000]),
    FOLLOW_21_in_unary_list433: new ANTLR.misc.BitSet([0x00000002,0x00000000]),
    FOLLOW_20_in_multi_list446: new ANTLR.misc.BitSet([0x001001F0,0x00000000]),
    FOLLOW_block_in_multi_list450: new ANTLR.misc.BitSet([0x00400000,0x00000000]),
    FOLLOW_22_in_multi_list478: new ANTLR.misc.BitSet([0x001001F0,0x00000000]),
    FOLLOW_block_in_multi_list482: new ANTLR.misc.BitSet([0x00600000,0x00000000]),
    FOLLOW_21_in_multi_list489: new ANTLR.misc.BitSet([0x00000002,0x00000000]),
    FOLLOW_ID_in_atom500: new ANTLR.misc.BitSet([0x00000002,0x00000000]),
    FOLLOW_NUM_in_atom506: new ANTLR.misc.BitSet([0x00000002,0x00000000]),
    FOLLOW_STRING_in_atom535: new ANTLR.misc.BitSet([0x00000002,0x00000000]),
    FOLLOW_OPER_in_atom541: new ANTLR.misc.BitSet([0x00000002,0x00000000]),
    ...
    FOLLOW_atom_in_synpred10261: new ANTLR.misc.BitSet([0x00000002,0x00000000]),
    FOLLOW_list_in_synpred11330: new ANTLR.misc.BitSet([0x00000002,0x00000000]),
    FOLLOW_empty_list_in_synpred12345: new ANTLR.misc.BitSet([0x00000002,0x00000000]),
    FOLLOW_unary_list_in_synpred13373: new ANTLR.misc.BitSet([0x00000002,0x00000000])
});
