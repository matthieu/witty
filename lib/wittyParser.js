// $ANTLR 3.0.1 antlr/witty.g 2008-07-06 09:22:35
    ...
    atom: function() {
        ...
        try {
            ...
            default:
                if (this.backtracking>0) {this.failed=true; return val;}
                var nvae =
                    new ANTLR.runtime.NoViableAltException("52:1: atom returns [Object val] : ( ID | INNT | STRING | OPER );", 11, 0, this.input);
            ...
            switch (alt11) {
                ...
                case 2 :
                    ...
                    this.match(this.input,INNT,wittyParser.FOLLOW_INNT_in_atom506); if (this.failed) return val;
                    if ( this.backtracking===0 ) {
                       val = INNT12.getText(); 
                    }
...
ANTLR.lang.augmentObject(wittyParser, {
    ...
    FOLLOW_INNT_in_atom506: new ANTLR.misc.BitSet([0x00000002,0x00000000]),
