// $ANTLR 3.0.1 antlr/witty.g 2008-07-08 21:07:52
...
ANTLR.lang.extend(wittyParser, ANTLR.runtime.Parser, {
        ...
        try {
            ...
            switch (alt7) {
                case 1 :
                    ...
                    if (this.failed) return val;
                    if ( this.backtracking===0 ) {
                       val = [OPER1.getText(), u]; val.sntx = 'M'; 
                    }
    ...
    // antlr/witty.g:32:1: applic returns [Object val] : ( atom | parens_block ) ( list )+ ;
    // $ANTLR start applic
    applic: function() {
        var val = null;

         var atom5 = null;
         var parens_block6 = null;
         var list7 = null;

        try {
            // antlr/witty.g:33:21: ( ( atom | parens_block ) ( list )+ )
            // antlr/witty.g:33:23: ( atom | parens_block ) ( list )+
            // antlr/witty.g:33:23: ( atom | parens_block )
            var alt8=2;
            ...
            if ( ((LA8_0>=OPER && LA8_0<=STRING)) ) {
                ...
                if (this.backtracking>0) {this.failed=true; return val;}
                var nvae =
                    new ANTLR.runtime.NoViableAltException("33:23: ( atom | parens_block )", 8, 0, this.input);
            ...
            switch (alt8) {
                case 1 :
                    ...
                    break;
                case 2 :
                    // antlr/witty.g:34:25: parens_block
                    this.pushFollow(wittyParser.FOLLOW_parens_block_in_applic338);
                    var parens_block6 = this.parens_block();
                    this._fsp--;
                    if (this.failed) return val;
                    if ( this.backtracking===0 ) {
                       val = parens_block6; 
    ...
    // antlr/witty.g:37:1: parens_block returns [Object val] : '(' block ')' ;
    // $ANTLR start parens_block
    parens_block: function() {
        var val = null;

         var block8 = null;

        try {
            // antlr/witty.g:38:21: ( '(' block ')' )
            // antlr/witty.g:38:23: '(' block ')'
            this.match(this.input,20,wittyParser.FOLLOW_20_in_parens_block383); if (this.failed) return val;
            this.pushFollow(wittyParser.FOLLOW_block_in_parens_block385);
            var block8 = this.block();
            this._fsp--;
            if (this.failed) return val;
            this.match(this.input,21,wittyParser.FOLLOW_21_in_parens_block387); if (this.failed) return val;
            if ( this.backtracking===0 ) {
               val = [block8]; val.sntx = 'B'; 
            }
    ...
    // antlr/witty.g:40:1: list returns [Object val] : ( empty_list | unary_list | multi_list );
    // $ANTLR start list
    list: function() {
        var val = null;

         var empty_list9 = null;
         var unary_list10 = null;
         var multi_list11 = null;

        try {
            // antlr/witty.g:41:21: ( empty_list | unary_list | multi_list )
            var alt10=3;
            ...
            if ( (LA10_0==20) ) {
                ...
                if ( (this.synpred14()) ) {
                    ...
                    if (this.backtracking>0) {this.failed=true; return val;}
                    var nvae =
                        new ANTLR.runtime.NoViableAltException("40:1: list returns [Object val] : ( empty_list | unary_list | multi_list );", 10, 1, this.input);
                ...
                if (this.backtracking>0) {this.failed=true; return val;}
                var nvae =
                    new ANTLR.runtime.NoViableAltException("40:1: list returns [Object val] : ( empty_list | unary_list | multi_list );", 10, 0, this.input);

                throw nvae;
            }
            switch (alt10) {
                case 1 :
                    // antlr/witty.g:41:23: empty_list
                    this.pushFollow(wittyParser.FOLLOW_empty_list_in_list400);
                    var empty_list9 = this.empty_list();
                    this._fsp--;
                    if (this.failed) return val;
                    if ( this.backtracking===0 ) {
                       val = empty_list9; 
                    ...
                    break;
                case 2 :
                    // antlr/witty.g:42:25: unary_list
                    this.pushFollow(wittyParser.FOLLOW_unary_list_in_list428);
                    var unary_list10 = this.unary_list();
                    this._fsp--;
                    if (this.failed) return val;
                    if ( this.backtracking===0 ) {
                       val = unary_list10; 
                    ...
                    break;
                case 3 :
                    // antlr/witty.g:43:25: multi_list
                    this.pushFollow(wittyParser.FOLLOW_multi_list_in_list456);
                    var multi_list11 = this.multi_list();
                    this._fsp--;
                    if (this.failed) return val;
                    if ( this.backtracking===0 ) {
                       val = multi_list11; 
    ...
    // antlr/witty.g:45:1: empty_list returns [Object val] : '(' ')' ;
    ...
    empty_list: function() {
        ...
        try {
            // antlr/witty.g:46:21: ( '(' ')' )
            // antlr/witty.g:46:23: '(' ')'
            this.match(this.input,20,wittyParser.FOLLOW_20_in_empty_list469); if (this.failed) return val;
            this.match(this.input,21,wittyParser.FOLLOW_21_in_empty_list471); if (this.failed) return val;
            if ( this.backtracking===0 ) {
               val = []; val.sntx = 'L'; 
            }
    ...
    // antlr/witty.g:48:1: unary_list returns [Object val] : '(' block ')' ;
    ...
    unary_list: function() {
        ...
        try {
            // antlr/witty.g:49:21: ( '(' block ')' )
            // antlr/witty.g:49:23: '(' block ')'
            this.match(this.input,20,wittyParser.FOLLOW_20_in_unary_list484); if (this.failed) return val;
            this.pushFollow(wittyParser.FOLLOW_block_in_unary_list486);
            var block12 = this.block();
            this._fsp--;
            if (this.failed) return val;
            this.match(this.input,21,wittyParser.FOLLOW_21_in_unary_list488); if (this.failed) return val;
            if ( this.backtracking===0 ) {
               val = [block12]; val.sntx = 'L'; 
            }
    ...
    // antlr/witty.g:51:1: multi_list returns [Object val] : '(' b1= block ( ',' b2= block )+ ')' ;
    ...
    multi_list: function() {
        ...
        try {
            // antlr/witty.g:52:21: ( '(' b1= block ( ',' b2= block )+ ')' )
            // antlr/witty.g:52:23: '(' b1= block ( ',' b2= block )+ ')'
            this.match(this.input,20,wittyParser.FOLLOW_20_in_multi_list501); if (this.failed) return val;
            this.pushFollow(wittyParser.FOLLOW_block_in_multi_list505);
            var b1 = this.block();
            this._fsp--;
            if (this.failed) return val;
            if ( this.backtracking===0 ) {
            ...
            do {
                ...
                switch (alt11) {
            	case 1 :
            	    // antlr/witty.g:54:25: ',' b2= block
            	    this.match(this.input,22,wittyParser.FOLLOW_22_in_multi_list533); if (this.failed) return val;
            	    this.pushFollow(wittyParser.FOLLOW_block_in_multi_list537);
            	    var b2 = this.block();
            	    this._fsp--;
            	    if (this.failed) return val;
            	    if ( this.backtracking===0 ) {
            ...
            this.match(this.input,21,wittyParser.FOLLOW_21_in_multi_list544); if (this.failed) return val;
    ...
    // antlr/witty.g:56:1: atom returns [Object val] : ( ID | NUM | STRING | OPER );
    // $ANTLR start atom
    atom: function() {
        var val = null;
        ...
        try {
            // antlr/witty.g:57:21: ( ID | NUM | STRING | OPER )
            var alt12=4;
            switch ( this.input.LA(1) ) {
            case ID:
                alt12=1;
            ...
            default:
                if (this.backtracking>0) {this.failed=true; return val;}
                var nvae =
                    new ANTLR.runtime.NoViableAltException("56:1: atom returns [Object val] : ( ID | NUM | STRING | OPER );", 12, 0, this.input);
            ...
            switch (alt12) {
                case 1 :
                    // antlr/witty.g:57:23: ID
                    ID13=this.input.LT(1);
                    this.match(this.input,ID,wittyParser.FOLLOW_ID_in_atom555); if (this.failed) return val;
                    if ( this.backtracking===0 ) {
                       val = ID13.getText(); 
                    }
                    ...
                    break;
                case 2 :
                    // antlr/witty.g:57:49: NUM
                    NUM14=this.input.LT(1);
                    this.match(this.input,NUM,wittyParser.FOLLOW_NUM_in_atom561); if (this.failed) return val;
                    if ( this.backtracking===0 ) {
                       val = NUM14.getText(); 
                    }
                    ...
                    break;
                case 3 :
                    // antlr/witty.g:58:25: STRING
                    STRING15=this.input.LT(1);
                    this.match(this.input,STRING,wittyParser.FOLLOW_STRING_in_atom590); if (this.failed) return val;
                    if ( this.backtracking===0 ) {
                      val = STRING15.getText(); 
                    }


                    break;
                case 4 :
                    // antlr/witty.g:58:58: OPER
                    OPER16=this.input.LT(1);
                    this.match(this.input,OPER,wittyParser.FOLLOW_OPER_in_atom596); if (this.failed) return val;
                    if ( this.backtracking===0 ) {
                       val = OPER16.getText(); 
                    }
    ...
    synpred14_fragment: function() {   
        // antlr/witty.g:41:23: ( empty_list )
        // antlr/witty.g:41:23: empty_list
        this.pushFollow(wittyParser.FOLLOW_empty_list_in_synpred14400);
        this.empty_list();
        this._fsp--;
        if (this.failed) return ;
    ...
    synpred15_fragment: function() {   
        // antlr/witty.g:42:25: ( unary_list )
        // antlr/witty.g:42:25: unary_list
        this.pushFollow(wittyParser.FOLLOW_unary_list_in_synpred15428);
        this.unary_list();
        this._fsp--;
        if (this.failed) return ;
...
ANTLR.lang.augmentObject(wittyParser, {
    ...
    FOLLOW_parens_block_in_applic338: new ANTLR.misc.BitSet([0x00100000,0x00000000]),
    FOLLOW_list_in_applic368: new ANTLR.misc.BitSet([0x00100002,0x00000000]),
    FOLLOW_20_in_parens_block383: new ANTLR.misc.BitSet([0x001001F0,0x00000000]),
    FOLLOW_block_in_parens_block385: new ANTLR.misc.BitSet([0x00200000,0x00000000]),
    FOLLOW_21_in_parens_block387: new ANTLR.misc.BitSet([0x00000002,0x00000000]),
    FOLLOW_empty_list_in_list400: new ANTLR.misc.BitSet([0x00000002,0x00000000]),
    FOLLOW_unary_list_in_list428: new ANTLR.misc.BitSet([0x00000002,0x00000000]),
    FOLLOW_multi_list_in_list456: new ANTLR.misc.BitSet([0x00000002,0x00000000]),
    FOLLOW_20_in_empty_list469: new ANTLR.misc.BitSet([0x00200000,0x00000000]),
    FOLLOW_21_in_empty_list471: new ANTLR.misc.BitSet([0x00000002,0x00000000]),
    FOLLOW_20_in_unary_list484: new ANTLR.misc.BitSet([0x001001F0,0x00000000]),
    FOLLOW_block_in_unary_list486: new ANTLR.misc.BitSet([0x00200000,0x00000000]),
    FOLLOW_21_in_unary_list488: new ANTLR.misc.BitSet([0x00000002,0x00000000]),
    FOLLOW_20_in_multi_list501: new ANTLR.misc.BitSet([0x001001F0,0x00000000]),
    FOLLOW_block_in_multi_list505: new ANTLR.misc.BitSet([0x00400000,0x00000000]),
    FOLLOW_22_in_multi_list533: new ANTLR.misc.BitSet([0x001001F0,0x00000000]),
    FOLLOW_block_in_multi_list537: new ANTLR.misc.BitSet([0x00600000,0x00000000]),
    FOLLOW_21_in_multi_list544: new ANTLR.misc.BitSet([0x00000002,0x00000000]),
    FOLLOW_ID_in_atom555: new ANTLR.misc.BitSet([0x00000002,0x00000000]),
    FOLLOW_NUM_in_atom561: new ANTLR.misc.BitSet([0x00000002,0x00000000]),
    FOLLOW_STRING_in_atom590: new ANTLR.misc.BitSet([0x00000002,0x00000000]),
    FOLLOW_OPER_in_atom596: new ANTLR.misc.BitSet([0x00000002,0x00000000]),
    ...
    FOLLOW_empty_list_in_synpred14400: new ANTLR.misc.BitSet([0x00000002,0x00000000]),
    FOLLOW_unary_list_in_synpred15428: new ANTLR.misc.BitSet([0x00000002,0x00000000])
});
