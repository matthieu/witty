...
return (o && (typeof o === 'object' || ANTLR.lang.isFunction(o))) || false;
    ...
    extend: function(subc, superc, overrides) {
        ...
        if (overrides) {
            ...
            ANTLR.lang._IEEnumFix(subc.prototype, overrides);
        }
    },
...
ANTLR.runtime.CommonToken.prototype = {
    ...
    toString: function() {
		...
		return "[@"+this.getTokenIndex()+","+this.start+":"+this.stop+"='"+txt+"',<"+this.type+">"+this.channelStr+","+this.line+":"+this.getCharPositionInLine()+"]";
	}
};
ANTLR.runtime.Token = {
    EOR_TOKEN_TYPE: 1,
...
ANTLR.lang.extend(ANTLR.runtime.Lexer, ANTLR.runtime.BaseRecognizer, {
    reset: function() {
		...
		this.token = null;
		this.type = ANTLR.runtime.Token.INVALID_TOKEN_TYPE;
		this.channel = ANTLR.runtime.Token.DEFAULT_CHANNEL;
		this.tokenStartCharIndex = -1;
    ...
    emit: function() {
        if (arguments.length===0) {
    		var t = new ANTLR.runtime.CommonToken(this.input, this.type, this.channel, this.tokenStartCharIndex, this.getCharIndex()-1);
